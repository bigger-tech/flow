...
export function signXdr(challengeXdr: string, mykoboCredentials: MykoboCredentials): object {
	const transaction = TransactionBuilder.fromXDR(
		challengeXdr,
		NetworkPassphrase[mykoboCredentials.stellarNetwork],
	);
	transaction.sign(Keypair.fromSecret(mykoboCredentials.secretKey));
