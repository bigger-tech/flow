...
export const withdrawExchangeDescription: INodeProperties[] = [
	...
	},
	{
        ...
        description: "Code of the on-chain asset the user wants to withdraw. The value passed must match one of the codes listed in the /info response's withdraw-exchange object."
	},
    {
	...
	},
    {
		...
		default: '',
        placeholder: '5.00',
        description: "The amount of the on-chain asset (source_asset) the user would like to send to the anchor's Stellar account. This field may be necessary for the anchor to determine what KYC information is necessary to collect. Should be equals to quote.sell_amount if a quote_id was used."
	},
    {
		displayName: 'Type',
		name: 'type',
        ...
        description: "Type of withdrawal. Can be: crypto, bank_account, cash, mobile, bill_payment or other custom values. This field may be necessary for the anchor to determine what KYC information is necessary to collect."
	},
    {
        ...
        description: "TThe account that the user wants to withdraw their funds to. This can be a crypto account, a bank account number, IBAN, mobile number, or email address."
	},
    {
	...
	},
    {
		...
		default: '',
        description: "Anchor can show this to the user when referencing the wallet involved in the withdrawal (ex. in the anchor's transaction history)."
	},
    {
	...
	},
    {
		...
		default: '',
        description: "The memo the anchor must use when sending refund payments back to the user. If not specified, the anchor should use the same memo used by the user to send the original payment. If specified, refund_memo_type must also be specified."
	},
    {
