...
export const withdrawDescription: INodeProperties[] = [
	...
	},
    {
		...
		default: '',
        placeholder: '5.00',
        description: "The amount of the asset the user would like to withdraw. This field may be necessary for the anchor to determine what KYC information is necessary to collect."
	},
    {
		displayName: 'Type',
		name: 'type',
